"""
Создание стеко-подобной структуры
...
Дополнительно: В классическом варианте Стек хранит последовательность данных.
Главный принцип работы стека — данные, которые попали в стек недавно, используются первыми.
Чем раньше попал — тем позже используется. После использования элемент стека исчезает,
и верхним становится следующий элемент.
"""
